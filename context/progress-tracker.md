...
- Phases 00–02 established lifecycle onboarding, recovery, and fresh local
  verification; their evidence is retained in `docs/lifecycle/`.
- Phase 03 accepted the `depth-sol/0.3` producer contract at `14e3b92`, with
  evidence at `2ee3a30`; F5 remediation is `6bdbeb8`.
- The separately owned A-Frame Bootstrap adoption and frozen GPT-6 Astra/high
  review accepted F1–F6 as PASS. The current closeout, history map, ledger, and
  archive manifest retain its dated limits and ownership boundary.
